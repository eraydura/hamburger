...
function extendTheme(themeOptions) {
  ...
  const lightColorSystem = {
    palette: {
      ...
      background: {
        ...
        backdrop: `rgba(${getCssVar("palette-neutral-darkChannel", colorChannel(defaultColors.neutral[900]))} / 0.25)`
      },
      divider: `rgba(${getCssVar("palette-neutral-mainChannel", colorChannel(defaultColors.neutral[500]))} / 0.2)`,
  ...
  const darkColorSystem = {
    palette: {
      ...
      background: {
        ...
        backdrop: `rgba(${getCssVar("palette-neutral-darkChannel", colorChannel(defaultColors.neutral[50]))} / 0.25)`
      },
      divider: `rgba(${getCssVar("palette-neutral-mainChannel", colorChannel(defaultColors.neutral[500]))} / 0.16)`,
      focusVisible: getCssVarColor("palette-primary-500")
    },
    shadowRing: "0 0 #000",
    shadowChannel: "0 0 0",
  ...
  const {
    vars: themeVars,
    generateCssVars
  } = prepareCssVars_default(_extends({
    colorSchemes
...
var CloseModalContext = React3.createContext(void 0);
...
//# sourceMappingURL=chunk-EW3RNWZD.js.map
